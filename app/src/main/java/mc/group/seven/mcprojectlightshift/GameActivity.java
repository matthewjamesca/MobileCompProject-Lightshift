...
public class GameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        overridePendingTransition(R.anim.pull_in_from_left, R.anim.hold); //when this activity start, push in from left.
    ...
    protected void onPause() {
        /*
        * when this active paused(other activity started), this active pushed out to the left
        * */
